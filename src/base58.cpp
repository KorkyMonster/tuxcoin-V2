...
public:
    ...
    bool operator()(const WitnessUnknown& id) const { return true; }
    bool operator()(const WitnessV0KeyHash& id) const { return true; }
    bool operator()(const WitnessV0ScriptHash& id) const { return true; }
